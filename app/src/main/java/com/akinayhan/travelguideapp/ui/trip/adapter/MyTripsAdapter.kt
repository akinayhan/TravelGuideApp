...
class MyTripsAdapter(var onClick :(Travel) -> Unit
) : RecyclerView.Adapter<MyTripsAdapter.ViewHolder>() {

    var travelList: List<Travel>? = null
    inner class ViewHolder(val binding: ItemTripBookmarkBinding) : RecyclerView.ViewHolder(binding.root)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        with(holder){
            ...
            binding.apply {
                ...
                txtCity.text = travelItem!!.description
